...
const DB_URL =  process.env.DATABASE_URL || 'mongodb+srv://DARKSHAN:1000@cluster0 .t1wsjlv.mongodb.net/';
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~d0703PJmq068ebe75d45f53032f91c27fda4', //your ssid to run bot
    HEROKU: {
    ...
    SUDO : process.env.SUDO || "94740119863",
